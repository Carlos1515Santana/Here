...
//    final List<OcorrenciaAgrupadoDTO> ocorrenciaList = await Dados_api.getOcorrenciaAgrupada(data_cel);
    ...
    var piedataGenero = [
      Task('Mulher', 49250, Color(0xff3366cc)),
      Task('Homem', 21745, Color(0xff302010))
    ];

    var piedataTruno = [
      Task('Manhã', 49250, Color(0xff3366cc)),
      Task('Tarde', 21745, Color(0xff302010)),
      Task('Noite', 21745, Color(0xff212ad0))
    ];
          ...
          appBar: AppBar(
            ...
            bottom: TabBar(
              ...
              tabs: [
                ...
                Tab(icon: Icon(FontAwesomeIcons.peopleArrows)),
                Tab(icon: Icon(FontAwesomeIcons.child)),
              ],
            ),
